...
#ifndef __MYSENSORS_NODE_SENSOR_DHT_H
#define __MYSENSORS_NODE_SENSOR_DHT_H
...
class MySensors_Node_Sensor_Dht : public MySensors_Node_Sensor {
  public:
    MySensors_Node_Sensor_Dht(   uint8_t  temperature_id  = 10,
                                 uint8_t  humidity_id     = 11,
                                 String   description     = "DHT",
                                 uint8_t  pin             = 4,      // Pin for dht device
                                 uint32_t interval        = 120000, // How often to read and send in ms
                                 int16_t  offset          = 0,      // Fixed offset of temperature
                                 uint8_t  type            = DHT22   // DHT11, DHT22
                               );
    ~MySensors_Node_Sensor_Dht();
